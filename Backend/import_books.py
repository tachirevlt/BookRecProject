...
"""
Script import du lieu tu books_with_tags_enhanced.csv vao SQL Server.
...
# --- Doc CSV ---
CSV_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "books_with_tags_enhanced.csv")
print(f"\nDoc CSV: {CSV_PATH}")
