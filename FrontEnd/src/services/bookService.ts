...
/**
 * Kiểu phân trang trả về từ Backend.
 * Backend trả về PascalCase nhưng .NET System.Text.Json mặc định serialize camelCase.
 * Axios nhận về: { pageNumber, pageSize, totalCount, items }
 */
