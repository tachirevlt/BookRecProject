              ...
              <motion.div
                ...
                <div className="bg-white/90 dark:bg-[#16152B]/90 backdrop-blur-xl rounded-3xl border border-gray-100/80 dark:border-white/8 p-6 shadow-sm">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white font-bold shadow-lg" style={{ fontSize: '2rem' }}>
                      MA
                    </div>
                    <div className="flex-1">
                      <button className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-2xl font-medium text-sm hover:opacity-95 transition-all shadow-md shadow-indigo-200/60 dark:shadow-indigo-900/30">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl text-gray-900 dark:text-white outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100/50 dark:focus:ring-indigo-900/30 transition-all"
                      />
                    </div>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {[
                          ...
                          <button
                            ...
                            className={`px-4 py-3 rounded-2xl font-medium text-sm border transition-all ${profileData.gender === option.value
                    ...
                    <div>
                      <label className="block text-gray-700 dark:text-gray-300 text-sm font-medium mb-2">Giới thiệu bản thân</label>
                      <textarea
                ...
                {/* Favorite Genres */}
                <div className="bg-white/90 dark:bg-[#16152B]/90 backdrop-blur-xl rounded-3xl border border-gray-100/80 dark:border-white/8 p-6 shadow-sm">
                  <h3 className="text-gray-900 dark:text-white font-semibold mb-4">Thể loại yêu thích</h3>
                ...
                {/* Save Button */}
                <button className="w-full py-3.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-2xl font-semibold shadow-lg shadow-indigo-200/60 dark:shadow-indigo-900/30 hover:opacity-95 transition-all">
                  Lưu thay đổi
                </button>
            ...
            {activeTab === 'password' && (
              <motion.div
                ...
                <div className="bg-white/90 dark:bg-[#16152B]/90 backdrop-blur-xl rounded-3xl border border-gray-100/80 dark:border-white/8 p-6 shadow-sm">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full px-4 py-3 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl text-gray-900 dark:text-white placeholder:text-gray-400 outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100/50 dark:focus:ring-indigo-900/30 transition-all"
                      />
                    </div>
                    <div>
                  ...
                  <button className="w-full py-3.5 bg-gradient-to-r from-indigo-600 to-violet-600 text-white rounded-2xl font-semibold shadow-lg shadow-indigo-200/60 dark:shadow-indigo-900/30 hover:opacity-95 transition-all mt-6">
                    Cập nhật mật khẩu
                  </button>
                </div>
